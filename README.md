...
- Провода соединения (по неисследованиеимости)
...
2. Установите неисследованиеимые библиотеки. В Arduino IDE перейдите в "Скетч" -> "Подключить библиотеку". Установите библиотеки для USB Host Shield и TFT дисплея ILI9488, например, "USB Host Shield Library 2.0" и "Adafruit ILI9488" или "MCUFRIEND_kbv" (в зависимости от вашего дисплея).
